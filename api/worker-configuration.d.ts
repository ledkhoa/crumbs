/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 278a6cbdb0d39f25a1a00615b0674046)
...
interface __BaseEnv_CloudflareBindings {
  ...
  INGEST_WORKFLOW: Workflow<
    Parameters<import('./src/index').IngestWorkflow['run']>[0]['payload']
  >;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'GOOGLE_GENERATIVE_AI_API_KEY' | 'APIFY_TOKEN'>
  > {}
}
